...
@pytest.mark.parametrize("rel", [contract.ETHICS_CHECKLIST, contract.IRB_REFERENCE])
def test_post_migration_authority_boundary_is_pinned(tmp_path: Path, rel: Path) -> None:
