...
def test_full_view_carries_banner_three_parts_and_fixed_wording():
    ...
    assert (
        ...
        "1/1 selected candidates were classified support."
        in text
...
def test_provider_text_renders_inert():
    ...
    tampered["candidate_ledger_sha256"] = ledger.bound_digest(tampered, "candidate_ledger_sha256")
...
def test_per_source_rows_carry_the_required_fields():
    ...
    assert "This candidate's inspected abstract was classified support relative to claim" in text
