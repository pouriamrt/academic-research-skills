...
"
    ...
    # Banner deliberately kept to ~500 chars (v3.20.1): per-command model
    # routing and agent inventory live in .claude/CLAUDE.md, not here.
    ANNOUNCE="${UPDATE_LINE}ARS (academic-research-skills) v3.21.0 loaded.
