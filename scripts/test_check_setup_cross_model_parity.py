...
class SetupCrossModelParityTests(unittest.TestCase):
    ...
    def test_clean_fixture_passes(self) -> None:
        module = _load_module()
        self.assertEqual(module.check(EN_OK, CANONICAL_OK), [])
    ...
    def test_legacy_id_in_prose_note_does_not_count(self) -> None:
        ...
        errors = module.check(stale, CANONICAL_OK)
        self.assertTrue(
    ...
    def test_wildcard_prefix_tokens_are_not_ids(self) -> None:
        ...
        errors = module.check(glob_setup, canonical)
        self.assertTrue(
    ...
    def test_unknown_model_fails(self) -> None:
        ...
        errors = module.check(bad, CANONICAL_OK)
        self.assertTrue(
