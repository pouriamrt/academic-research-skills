# ARS Pipeline Architecture (fork v3.22.0; upstream merge through v3.19.0+)
...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.22.0<br/>Agent Team: 5 in-skill + 1 shared]
