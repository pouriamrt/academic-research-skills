# ARS Pipeline Architecture (fork v3.20.0; upstream merge through v3.17.0)
...
```mermaid
graph TD
    Pipeline[academic-pipeline<br/>orchestrator<br/>v3.20.0<br/>Agent Team: 5 in-skill + 1 shared]
