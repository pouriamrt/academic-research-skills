...
| # | Revision Item | Sub-Claim(s) | Flags | Source | Priority | Estimated Effort |
|---|--------------|--------------|-------|--------|----------|-----------------|
| R1 | [Description] | [SC-n] | | [EIC/R1/R2/R3] | P1 | [Time] |
| R2 | Collect validation data on algorithm bias | [SC-n] | `requires_new_experiment: true`, `experiment_type: new_experiment` | R2 | P1 | 4 weeks |
...
