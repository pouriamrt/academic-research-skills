...
ALLOWED_DIRECT_IMPORTS = {
    ...
    "sys",
    "unicodedata",
    "run_indirect_prompt_injection_probe",
}
...
ALLOWED_FUNCTIONS = {
    ...
    "_validate_run_tree",
    "_relative_files_and_directories",
    "_parent_directories",
    "_schema",
    "_validate_schema",
    "_timestamp",
    "_repo_path",
    "_repository_head_commit",
    "_asset_bindings",
    "_execution",
    "_observed_execution",
    "_scenario_index",
    "_factor_order",
    "_ordered_assignments",
    "_call_envelope",
    "_build_plan",
    "_config_from_plan",
    "_validate_plan",
    "_initial_manifest",
    "_validate_manifest",
    "_expected_run_inventory",
    "_unregistered_tree_snapshot",
    "_validate_run_inventory",
    "_decode_base64",
    "_validate_stop_intent",
    "_recover_stop_intent",
    "_validate_preload_quarantine",
    "_load_run",
    "_validate_ingestion_journal_lifecycle",
    "init_run",
    "_material_map",
    "_validate_materials",
    "materialize",
    "_response_diagnostics",
    "_has_visible_semantic_text",
    "_closed_embedded_object",
    "_normalize_raw_event",
    "_external_session_receipt",
    "_validate_transcript",
    "_validate_authorization_record",
    "_receipt_value",
    "_preserved_ingestion_artifacts",
    "_validate_ingested_artifacts",
    "validate_run",
    "_record_stop",
    "_record_preload_quarantine",
    "ingest",
    "_blind_identifiers",
    "_normalized_blind_text",
    "_compact_blind_text",
    "_fold_blind_alphanumeric",
    "_blind_screen_text",
    "_joined_blind_text",
    "_contains_complete_compact_identifier",
    "_contains_compact_phrase",
    "_assert_blindable_transcript",
    "_assert_blind_packet_structure",
    "visit",
    "_assignment_boundary",
    "_blind_packet_value",
    "_blind_inventory_value",
    "_private_map_value",
    "_blind_manifest_value",
    "_source_ingestion_manifest",
    "_validate_blind_bundle",
    "_finalize_blind_state",
    ...
    for node in ast.walk(tree):
        if isinstance(node, ast.Import):
            ...
            for alias in node.names:
                ...
                allowed_alias = (module, alias.name, alias.asname) in ALLOWED_IMPORT_ALIASES
                if (
                    alias.name not in allowed_symbols
                    or alias.name == "*"
                    or (alias.asname is not None and not allowed_alias)
                ):
                    errors.append(
