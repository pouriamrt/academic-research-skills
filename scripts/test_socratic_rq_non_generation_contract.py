...
_END_VERB = re.compile(r"auto-?compile|automatically compile|\bends?\b|\bterminat", re.IGNORECASE)
...
def _contract_errors(documents: dict[str, str]) -> list[str]:
    ...
    management = _between(documents["protocol"], "## Dialogue Management Rules", "## Reading Probe")
