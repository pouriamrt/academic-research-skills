...
- **Output**: re-review mode — Revision response comparison table + new issues list + new Editorial Decision + R&R Traceability Matrix (Schema 18); fresh full review — the normal full-review package (5 review reports + Editorial Decision + Revision Roadmap), no R&R matrix
