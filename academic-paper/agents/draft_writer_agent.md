...
3. **Edit only** `will_address` items and only their exact authorized target/operation subsets (including experiment-backed items when a Schema 11-R result is available)
