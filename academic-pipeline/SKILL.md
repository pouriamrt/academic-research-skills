...
|---------|------|---------|
| 2.7 | 2026-03-18 | **Experiment Pipeline Integration**: Full Stage 1.5 wiring (experiment-designer → data-analyst/simulation-runner → lab-notebook); Schema 10/11/12/13 consumption in pipeline orchestrator; auto-detection of experiment requirements via Methodology Blueprint routing flags (`requires_experiment_design`, `requires_simulation`); lab-notebook continuous logging during experiment stages; Schema 11/12 integration into academic-paper Stage 2 (Results + Methods sections) |
