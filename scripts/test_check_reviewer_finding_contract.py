...
def test_m50_rcf_affirm_first_restored(tmp_path):
    ...
    _edit(
        ...
        RCF_REL,
        lambda t: t.replace(
            "Acknowledge genuine strengths, distinguish decision-bearing "
...
def test_m62_synth_roadmap_severity_column_dropped(tmp_path):
    ...
    _edit(
        ...
        lambda t: t.replace(
            ...
            "| Transport ref | Revision Item | Sub-Claim(s) | Source | Obligation class | Cost scope | Bounded consequence |",
            1,
        ),
    )
    code, err = _run2(root)
