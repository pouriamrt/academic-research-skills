...
| R2 | Collect validation data on algorithm bias (`requires_new_experiment: true`, `experiment_type: new_experiment` — see Step 5.5) | [SC-n] | [transported] | [transported] | [transported] | R2 | P1 | 4 weeks |
...
